...
- `is-energy-only` - When set to `"true"`, passes `is_energy_only` to the address router and shows a 2-second splash screen before redirecting to the checkout page
