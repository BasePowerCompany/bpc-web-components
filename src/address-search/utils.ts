 ...
 * the control/default behavior. Calling this records the experiment exposure
 * ($feature_flag_called) unless `send_event: false` is passed, so only call it
 * event-enabled once the user is eligible.
 */
